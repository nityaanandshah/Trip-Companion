    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* My Trips Card */}
          <div className="group overflow-hidden rounded-xl bg-white p-6 shadow-lg transition-all hover:shadow-2xl hover:-translate-y-1">
          ...
          <div className="group overflow-hidden rounded-xl bg-white p-6 shadow-lg transition-all hover:shadow-2xl hover:-translate-y-1">
            <div className="flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="text-3xl font-extrabold text-amber-600 mt-1">0</p>
              </div>
            </div>
            <div className="mt-6">
              <a
                href="/trips"
                className="inline-flex items-center text-sm font-semibold text-amber-600 hover:text-amber-700 group-hover:underline"
              >
                Browse trips
                <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
          ...
          <div className="group overflow-hidden rounded-xl bg-white p-6 shadow-lg transition-all hover:shadow-2xl hover:-translate-y-1">
            ...
            <div className="mt-6">
              <a
                href="/profile/edit"
                className="inline-flex items-center text-sm font-semibold text-emerald-600 hover:text-emerald-700 group-hover:underline"
              >
                Edit profile
                <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
        ...
        <div className="mt-8 rounded-xl bg-white p-8 shadow-lg">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="/notifications"
              className="group flex items-center gap-2 rounded-xl border-2 border-gray-200 bg-white px-6 py-3 text-sm font-semibold text-gray-700 hover:border-purple-500 hover:text-purple-600 hover:shadow-md transition-all focus:outline-none focus:ring-4 focus:ring-purple-300"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
